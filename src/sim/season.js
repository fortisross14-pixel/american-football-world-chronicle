...
function finishSeasonMutable(u,rng){
  ...
  u.postseasonState.complete=true;u.phase='Season Complete';u.offseasonState={year:u.year,stageIndex:0,started:false,complete:false,summary,events:{coachMarket:[],transfers:[],retirements:[],declarations:[],freeAgency:[],draft:[],trades:[],spawned:[]},declaredIds:[]};
}
